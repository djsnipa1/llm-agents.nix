...
stdenv.mkDerivation rec {
  ...
  # Fetch the only runtime dependency: chalk 5.6.2
  chalk = fetchurl {
  ...
  installPhase = ''
    ...
    # Create node_modules and install chalk (fetched via Nix)
  ...
  # Skip version check - the tool has a TUI on startup and doesn't support --version
